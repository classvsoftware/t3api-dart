...
part 'metrc_incoming_transfer.g.dart';
...
/// * [lineNumber] 
@BuiltValue()
abstract class MetrcIncomingTransfer implements Built<MetrcIncomingTransfer, MetrcIncomingTransferBuilder> {
  ...
  MetrcIncomingTransferIndexEnum? get index;
  // enum indexEnum {  ACTIVE_INCOMING_TRANSFER,  INACTIVE_INCOMING_TRANSFER,  };
  ...
  MetrcIncomingTransfer._();

  factory MetrcIncomingTransfer([void updates(MetrcIncomingTransferBuilder b)]) = _$MetrcIncomingTransfer;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(MetrcIncomingTransferBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<MetrcIncomingTransfer> get serializer => _$MetrcIncomingTransferSerializer();
}

class _$MetrcIncomingTransferSerializer implements PrimitiveSerializer<MetrcIncomingTransfer> {
  @override
  final Iterable<Type> types = const [MetrcIncomingTransfer, _$MetrcIncomingTransfer];

  @override
  final String wireName = r'MetrcIncomingTransfer';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    MetrcIncomingTransfer object, {
    ...
    if (object.index != null) {
      ...
      yield serializers.serialize(
        object.index,
        specifiedType: const FullType(MetrcIncomingTransferIndexEnum),
      );
    }
    if (object.id != null) {
      yield r'id';
  ...
  void _deserializeProperties(
    ...
    required MetrcIncomingTransferBuilder result,
      ...
      switch (key) {
        ...
        case r'index':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(MetrcIncomingTransferIndexEnum),
          ) as MetrcIncomingTransferIndexEnum;
  ...
  @override
  MetrcIncomingTransfer deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = MetrcIncomingTransferBuilder();
...
class MetrcIncomingTransferIndexEnum extends EnumClass {

  /// Describes the current state of this object at the time it was returned from the API. This cannot be used to sort or filter.
  @BuiltValueEnumConst(wireName: r'ACTIVE_INCOMING_TRANSFER')
  static const MetrcIncomingTransferIndexEnum ACTIVE_INCOMING_TRANSFER = _$metrcIncomingTransferIndexEnum_ACTIVE_INCOMING_TRANSFER;
  /// Describes the current state of this object at the time it was returned from the API. This cannot be used to sort or filter.
  @BuiltValueEnumConst(wireName: r'INACTIVE_INCOMING_TRANSFER')
  static const MetrcIncomingTransferIndexEnum INACTIVE_INCOMING_TRANSFER = _$metrcIncomingTransferIndexEnum_INACTIVE_INCOMING_TRANSFER;

  static Serializer<MetrcIncomingTransferIndexEnum> get serializer => _$metrcIncomingTransferIndexEnumSerializer;

  const MetrcIncomingTransferIndexEnum._(String name): super(name);

  static BuiltSet<MetrcIncomingTransferIndexEnum> get values => _$metrcIncomingTransferIndexEnumValues;
  static MetrcIncomingTransferIndexEnum valueOf(String name) => _$metrcIncomingTransferIndexEnumValueOf(name);
}
