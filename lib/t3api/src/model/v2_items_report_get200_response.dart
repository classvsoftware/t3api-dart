...
part 'v2_items_report_get200_response.g.dart';
...
/// * [data] 
@BuiltValue()
abstract class V2ItemsReportGet200Response implements Built<V2ItemsReportGet200Response, V2ItemsReportGet200ResponseBuilder> {
  ...
  V2ItemsReportGet200Response._();

  factory V2ItemsReportGet200Response([void updates(V2ItemsReportGet200ResponseBuilder b)]) = _$V2ItemsReportGet200Response;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(V2ItemsReportGet200ResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<V2ItemsReportGet200Response> get serializer => _$V2ItemsReportGet200ResponseSerializer();
}

class _$V2ItemsReportGet200ResponseSerializer implements PrimitiveSerializer<V2ItemsReportGet200Response> {
  @override
  final Iterable<Type> types = const [V2ItemsReportGet200Response, _$V2ItemsReportGet200Response];

  @override
  final String wireName = r'V2ItemsReportGet200Response';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    V2ItemsReportGet200Response object, {
  ...
  void _deserializeProperties(
    ...
    required V2ItemsReportGet200ResponseBuilder result,
  ...
  @override
  V2ItemsReportGet200Response deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = V2ItemsReportGet200ResponseBuilder();
