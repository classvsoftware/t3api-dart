...
part 'metrc_harvest_report_response.g.dart';
...
/// * [data] 
@BuiltValue()
abstract class MetrcHarvestReportResponse implements Built<MetrcHarvestReportResponse, MetrcHarvestReportResponseBuilder> {
  ...
  MetrcHarvestReportResponse._();

  factory MetrcHarvestReportResponse([void updates(MetrcHarvestReportResponseBuilder b)]) = _$MetrcHarvestReportResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(MetrcHarvestReportResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<MetrcHarvestReportResponse> get serializer => _$MetrcHarvestReportResponseSerializer();
}

class _$MetrcHarvestReportResponseSerializer implements PrimitiveSerializer<MetrcHarvestReportResponse> {
  @override
  final Iterable<Type> types = const [MetrcHarvestReportResponse, _$MetrcHarvestReportResponse];

  @override
  final String wireName = r'MetrcHarvestReportResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    MetrcHarvestReportResponse object, {
  ...
  void _deserializeProperties(
    ...
    required MetrcHarvestReportResponseBuilder result,
  ...
  @override
  MetrcHarvestReportResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = MetrcHarvestReportResponseBuilder();
